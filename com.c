...
//To do so we need to put every 10-pieces of RMS value ,square them, multiply by 200, accumulate to a sum and then divided by 2000 then square root to result
